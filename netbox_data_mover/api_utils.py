    ...
    def authenticate(self):
        ...
        for base_url in self.base_urls:
            if api_type == 'api-swagger':
                _authenticate_swagger(base_url)
            else:
                _authenticate_standard(base_url)
        ...
        def _authenticate_swagger(self, base_url):
            ...
            if auth_method == 'apiKey':
                ...
                _handle_custom_login(http_client, base_url)
        ...
        def _authenticate_standard(self, base_url):
            ...
            auth_method = self.auth_method
            auth_func = _get_auth_function(module, self.auth_function)
            auth_args = _prepare_auth_args(base_url)
