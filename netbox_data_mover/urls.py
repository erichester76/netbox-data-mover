...
urlpatterns = [
    ...
    path('datamoverconfigs/import/', views.DataMoverConfigBulkImportView.as_view(), name='datamoverconfig_bulk_import'),
    ...
    path('datamoverdatasources/import/', views.DataMoverDataSourceBulkImportView.as_view(), name='datamoverdatasource_bulk_import'),
    ...
    path('inspect_datasource/', views.inspect_datasource, name='inspect_module'),
